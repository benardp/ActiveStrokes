...
void main()
{
  ...
  FragmentColor += texture2DRect( src_tex, ( gl_FragCoord.xy + vec2(1.3846153846, 0.0) ) ) * 0.3162162162;
  FragmentColor += texture2DRect( src_tex, ( gl_FragCoord.xy - vec2(1.3846153846, 0.0) ) ) * 0.3162162162;
  FragmentColor += texture2DRect( src_tex, ( gl_FragCoord.xy + vec2(3.2307692308, 0.0) ) ) * 0.0702702703;
  FragmentColor += texture2DRect( src_tex, ( gl_FragCoord.xy - vec2(3.2307692308, 0.0) ) ) * 0.0702702703;
