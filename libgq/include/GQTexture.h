...
public:
    ...
    void setWrapMode(int modeS, int modeT) const;
...
public:
    ~GQTexture3D();
    bool load( const QString& filename);
    bool loadOffsetFile( const QString& filename);
